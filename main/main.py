...
app.add_url_rule('/organisations', view_func=suppliers.SupplierListView.as_view('view_supplier_list'))
app.add_url_rule('/organisation/<org_id>', view_func=suppliers.SupplierView.as_view('view_supplier'))
